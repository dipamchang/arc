...
<% HttpSession sess = request.getSession();  String id = (String)sess.getAttribute("LOGIN_USER"); sess.setAttribute("LOGIN_USER",null);String name = (String)sess.getAttribute("NAME");    %>
<%String emailid="f2014" + id.substring(8, 11); %>
<body>

	<div class="ui page grid">
	<div class="ui top right purple attached label">Auto Logged out and Redirecting to Login page in 10 secs.</div>
		<div class="row">
			<div class="column">
				<br> <br>
				<h2 class="ui dividing header">
					ARC Semester II  2014 - 2015 Registration for - <i><%=name %></i><a class="anchor" id="types"></a>
				</h2>
			</div>
		</div>
		<div class="row">
				...
				<div class="ui positive message">
					 <i class="checkmark huge icon"></i>
  					<div class=" huge header middle floated">
    					SUCCESS
  					<p>You have been registered for Combination -<b> <%=request.getParameter("comb") %></b></p>
  					</div>
...
sendTheMail(co);
 setTimeout(function(){ window.location = "/arc/login.jsp"; }, delay);
